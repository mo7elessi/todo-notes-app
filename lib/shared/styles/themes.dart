...
ThemeData themeLight = ThemeData(
  ...
  textTheme: const TextTheme(
      bodyText1: TextStyle(
          fontSize: 14.0, color: titleColor, fontWeight: FontWeight.bold),
      subtitle1: TextStyle(fontSize: 12.0, color: detColor),
      subtitle2: TextStyle(fontSize: 14.0, color: detColor),
      headline6: TextStyle(fontSize: 12.5, color: Color(0xff2f2c2c)),
      headline1: TextStyle(
          fontSize: 14.5,
...
ThemeData themeDark = ThemeData(
  ...
  textTheme: const TextTheme(
      ...
      headline6: TextStyle(fontSize: 12.5, color: Colors.white),
      headline5: TextStyle(
